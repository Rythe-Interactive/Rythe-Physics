...
namespace rythe::physics
{
	...
	{
	public:
		ConvexConvergenceIdentifier(
			const EdgeLabel& label, float pTotalLambda, float pTangent1Lambda, float pTangent2Lambda, int pRefColliderId
		)
		...
		bool IsEqual(physics_contact& contact) override { return label == contact.label; }
