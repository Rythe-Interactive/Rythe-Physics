...
namespace rythe::physics
{
	...
	{
		collision_event_base(physics_manifold* m, float d)
			: manifold(m),
			  physics_delta(d)
		{
		}
		 ...
		 */
		[[nodiscard]] std::pair<PhysicsCollider*, PhysicsCollider*> colliders() const noexcept
		{
	...
	{
		request_flip_physics_continuous(bool continuousState)
			: newContinuousState{continuousState}
		{
		}
